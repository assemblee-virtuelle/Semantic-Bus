...
module.exports = {
  ...
  resolveComponent(component, requestDirection, pushData) {
    ...
    return new Promise((resolve, reject) => {
      workspace_component_lib.get_all({
        ...
        // console.log("table component", components.length)
        ...
        // console.log("function : resolveComponent | variable : pathResolution_length", this.pathResolution.length)
  ...
  processNextBuildPath() {
    ...
    console.log("linkNotResolved ||", linkNotResolved)
  ...
  buildPathResolution(component, requestDirection, depth, usableComponents, buildPath) {
    ...
    if (depth < 100) {
      ...
      var out = [];
      console.log("function : buildPathResolution | variable :currentcomponent", component._id)
      if (component.connectionsBefore != undefined && component.connectionsBefore.length > 0 && !(requestDirection == 'pull' && module.stepNode == true)) {
        for (var beforeComponent of component.connectionsBefore) {
          console.log("function : buildPathResolution | variable :beforecomponent", beforeComponent)
        ...
        console.log("function : buildPathResolution | variable :pull source")
      }
      if (component.connectionsAfter != undefined && component.connectionsAfter.length > 0 && !(requestDirection == 'push' && module.stepNode == true)) {
        for (var afterComponent of component.connectionsAfter) {
          console.log("function : buildPathResolution | variable :aftercomponent", afterComponent)
          var afterComponentObject = this.sift({
            "_id": afterComponent
          }, usableComponents)[0];
          var linkToProcess = {
            source: component,
            destination: afterComponent,
    ...
    return new Promise((resolve, reject) => {
      ...
      if (component.connectionsBefore.length > 0 && (module.stepNode != true || notMainNode != true)) {
        ...
        Promise.all(
          ...
          console.log("connect before", workspaceComponents)
          Promise.all(
          ...
          console.log(connectionsBeforeData)
