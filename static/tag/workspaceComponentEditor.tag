<workspace-component-editor class="containerV" style="flex-grow:1">
  ...
  <script>
    ...
    componentClickToConnectAfter(e) {
      console.log("componentClick", e.item);
      //console.log("componentClick",e.item); RiotControl.trigger('item_current_connect_after', e.item);
    ...
    deleteConnectionAfter(e) {
      //console.log('ComponentClickToNavigate', e.item); RiotControl.trigger('item_current_editById', e.item._id);
