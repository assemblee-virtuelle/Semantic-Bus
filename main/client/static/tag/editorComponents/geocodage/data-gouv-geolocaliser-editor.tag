<data-gouv-geolocaliser-editor>
  ...
  <!-- Titre du composant -->
  <div class="contenaireV title-component">data.gouv geocoding</div>
  <div>
    <div class="bar"/>
  </div>
  <!-- Description du composant -->
  <div class="title-description-component">Interroger l'API adresse.data.gouv.fr pour trouver une adresse avec la latitude et la longitude.</div>
  <!-- Champ du composant -->
  <div>
    <div class="bar"/>
  </div>
