...
do
   case $REPLY in
      1)  export CONFIG_URL="https://data-players.github.io/StrongBox/public/dev-mac.json" && docker-compose -f docker-compose.dev.yaml up -d --force-recreate
          break;;
      2)  export CONFIG_URL="https://data-players.github.io/StrongBox/public/dev-linux.json" && docker-compose -f docker-compose.dev.yaml up -d --force-recreate
          break;;
